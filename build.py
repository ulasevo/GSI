...
@media(max-width:760px){{main{{width:min(100% - 24px,620px);padding-top:12px}} nav span{{display:none}} .transmission-sequence{{min-height:calc(var(--transmission-count) * 45svh);margin-top:18px}} .transmission-window{{top:6px;height:calc(100svh - 12px)}} .transmission-stack{{width:100%;height:100%}} .broadcast-record{{height:96px;grid-template-columns:82px minmax(0,1fr)}} .broadcast-record.is-active{{top:10%;height:76%;grid-template-columns:1fr;grid-template-rows:minmax(0,1fr) auto;border-radius:15px 40px 15px 40px}} .broadcast-art img,.broadcast-art .cover-missing{{min-height:0}} .broadcast-record.is-active .broadcast-art img,.broadcast-record.is-active .broadcast-art .cover-missing{{aspect-ratio:1;height:auto}} .radio-watermark{{left:8%;right:4%;top:55%;bottom:4%;font-size:clamp(78px,24vw,132px)}} .broadcast-copy{{padding:12px 14px;min-width:0;background:linear-gradient(180deg,rgba(12,11,15,.35),rgba(12,11,15,.84))}} .broadcast-copy h2{{font-size:20px;max-width:100%;overflow-wrap:anywhere}} .broadcast-copy p{{font-size:14px}} .broadcast-record.is-active .broadcast-copy{{padding:22px 22px 26px}} .broadcast-record.is-active .broadcast-copy h2{{font-size:clamp(38px,11vw,66px);max-width:100%;overflow-wrap:anywhere}} .transmission-step{{height:45svh}}}}
